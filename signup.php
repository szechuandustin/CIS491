...
<html>
    ...
    <body>
        ...
        <form action="signupconf.php" method="post">
            <tr>
	           <td>First Name&emsp;&emsp;</td>
	           <td align="center"><input type="text" name="firstname" size="30" /></td><br><br>
            </tr>
            <tr>
	           <td>Last Name&emsp;&emsp;</td>
	           <td align="center"><input type="text" name="lastname" size="30" /></td><br><br>
            </tr>
            <tr>
	           <td>User Name&emsp;&emsp;</td>
	           <td align="center"><input type="text" name="username" size="30" /></td><br><br>
            </tr>
            <tr>
                <td>Address&emsp;&emsp;&emsp;</td>
                <td align="center"><input type="text" name="streetaddress" size="30" /></td><br><br>
            </tr>

            <tr>
                <td>City&emsp;&emsp;&emsp;&emsp;&emsp;</td>
                <td align="center"><input type="text" name="cityaddress" size="30"  /></td><br><br>
            </tr>
